...
$act = New-ScheduledTaskAction -WorkingDirectory $(Get-Location) -Execute """$((Get-Command Node).Source)""" -Argument "main.js"

Register-ScheduledTask -TaskName VRChat-OSCProxyHub -TaskPath nekomimiStudio -Trigger $tri -Principal $pri -Action $act -Force
Start-Sleep -s 1